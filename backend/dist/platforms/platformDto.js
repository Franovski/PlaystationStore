...
let CreatePlatformDto = class CreatePlatformDto {
};
exports.CreatePlatformDto = CreatePlatformDto;
__decorate([
    (0, graphql_1.Field)(() => platformEntity_1.PlatformName),
...
exports.CreatePlatformDto = CreatePlatformDto = __decorate([
    (0, graphql_1.InputType)()
], CreatePlatformDto);
let UpdatePlatformDto = class UpdatePlatformDto {
};
exports.UpdatePlatformDto = UpdatePlatformDto;
__decorate([
    (0, graphql_1.Field)(() => platformEntity_1.PlatformName, { nullable: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(platformEntity_1.PlatformName, { message: 'platformName must be either ps4 or ps5' }),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], UpdatePlatformDto.prototype, "platformName", void 0);
exports.UpdatePlatformDto = UpdatePlatformDto = __decorate([
    (0, graphql_1.InputType)()
], UpdatePlatformDto);
